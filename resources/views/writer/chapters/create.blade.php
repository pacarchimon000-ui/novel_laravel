...
<div class="container" style="padding: 2rem 0 4rem; max-width: 900px;">
    <div class="section-header" style="margin-bottom: 1.5rem;">
        <div>
            ...
            <h1>Tambah Chapter - {{ $novel->title }}</h1>
        </div>
    </div>

    <div class="admin-card">
        <div class="admin-card-body">
            <form method="POST" action="{{ route('writer.chapters.store', $novel) }}">
                @csrf

                <div class="form-grid">
                    <div class="form-group">
                        <label for="chapter_number">Nomor Chapter</label>
                        <input type="number" id="chapter_number" name="chapter_number" min="1" value="{{ old('chapter_number', $nextNumber) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea id="content" name="content" rows="18" required>{{ old('content') }}</textarea>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="coin_price" name="coin_price" min="1" value="{{ old('coin_price', 5) }}">
