...
<div class="container" style="padding: 2rem 0 4rem; max-width: 900px;">
    ...
    <div class="admin-card">
        <div class="admin-card-body">
            <form method="POST" action="{{ route('writer.novels.update', $novel) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title', $novel->title) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea id="synopsis" name="synopsis" rows="8" required>{{ old('synopsis', $novel->synopsis) }}</textarea>
